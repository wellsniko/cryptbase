...
return (
    ...
    <tr className="price-index-row">
     ...
     <td className="t2-r1"> <div className="div-t2-r1"><label className="label-t2-r1"> <Link to={`/signup`} className="index-link" style={{ textDecoration: 'none' }}><button id="nu-index-trade-button">Buy</button> </Link> </label></div> </td>
